...
1.  **Exploración y Preprocesamiento de Datos:** Limpieza, normalización y *Feature Engineering* (creación de la variable `type_white`).
2.  **Entrenamiento y Optimización de Modelos:** Comparativa de modelos de Regresión y Clasificación.
3.  **Aplicación Web (Streamlit):** Interfaz de usuario para la predicción en tiempo real.
...
| Métrica | AdaBoost Optimizado | Random Forest Optimizado |
| :--- | :--- | :--- |
| **Accuracy General** | **0.73** | 0.70 |
| **F1-Score Ponderado** | **0.73** | 0.69 |
| **F1-Score Clase Malo (0)** | **0.77** | 0.75 |
...
| Clase | Predicción Continua | Score Original (Calidad) |
| :--- | :--- | :--- |
| **Malo** | `< 0.75` | 3, 4, 5 |
| **Regular** | `0.75 - 0.94` | 6 |
| **Bueno** | `>= 0.95` | 7, 8, 9 |
...
| :--- | :--- | :--- |
| **Alcohol** | Positiva Fuerte (+0.45) | Es el factor más influyente. A mayor alcohol, mayor calidad. |
| **Densidad** | Negativa Fuerte (-0.32) | A mayor densidad, menor calidad. |
| **Acidez Volátil** | Negativa Media (-0.22) | Es un gran penalizador de la calidad (indica deterioro). |
| **Sulfatos** | Positiva Débil (+0.07) | Tienen una ligera correlación positiva. |
